// Q4 — Most common problems reported in negative reviews, per hotel in a city
// v1: $lookup + regex $addFields + $unwind + $group + runtime percentage calculation
// v2: pre-computed problem_stats[] (Attribute Pattern) → $match + $unwind on v2_hotels_guest
